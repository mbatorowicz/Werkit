...
export const resourceCategories = pgTable("resource_categories", {
  ...
  name: varchar("name", { length: 255 }).notNull(),
  parentId: integer("parent_id").references((): AnyPgColumn => resourceCategories.id, {
    onDelete: "set null",
  }),
...
export const materialCategories = pgTable("material_categories", {
  ...
  companyId: integer("company_id")
    ...
    .references(() => companies.id, { onDelete: "cascade" }),
  name: varchar("name", { length: 255 }).notNull(),
  parentId: integer("parent_id").references((): AnyPgColumn => materialCategories.id, {
    onDelete: "set null",
  }),
  isGroup: boolean("is_group").notNull().default(false),
  sortOrder: integer("sort_order").notNull().default(0),
...
export const workOrders = pgTable("work_orders", {
  ...
  materialId: integer("material_id").references(() => materials.id, { onDelete: "set null" }),
  customerId: integer("customer_id").references(() => customers.id, { onDelete: "set null" }),
  customerLocationId: integer("customer_location_id").references(() => customerLocations.id, {
    onDelete: "set null",
  }),
  taskDescription: text("task_description"),
...
export const sparePartCategories = pgTable("spare_part_categories", {
  ...
  companyId: integer("company_id")
    ...
    .references(() => companies.id, { onDelete: "cascade" }),
  name: varchar("name", { length: 255 }).notNull(),
  parentId: integer("parent_id").references((): AnyPgColumn => sparePartCategories.id, {
    onDelete: "set null",
  }),
  isGroup: boolean("is_group").notNull().default(false),
  sortOrder: integer("sort_order").notNull().default(0),
...
export const sparePartMachineCompatibilityRelations = relations(
...
export const workOrderSparePartsRelations = relations(workOrderSpareParts, ({ one }) => ({
  workOrder: one(workOrders, {
    fields: [workOrderSpareParts.workOrderId],
