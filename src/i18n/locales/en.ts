  ...
  admin: {
    ...
    materials: {
      ...
      pageSubtitleWarehouse:
        "Material catalog, stock in tons, and warehouse receipts and issues.",
      minStockLabel: "Minimum stock (t)",
      ...
      warehouse: {
        ...
        adjustHint: "Set current stock for “{name}” (in tons).",
