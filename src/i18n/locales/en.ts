...
export const en: AppDictionary = {
  ...
  dur: {
    sidebar: {
      resourceGroups: "Machine groups",
      spareParts: "Parts catalog",
      sparePartCategories: "Part categories",
      warehouse: "Warehouse operations",
    },
    resourceGroups: {
      title: "Machine groups (resource types)",
      subtitle:
        "Equipment type for DUR — e.g. capsule filler 02A. Assign many units of the same model to one group in the resource registry.",
      assignHint: "To assign a resource: Resources → edit resource → “Machine group” field.",
      loading: "Loading groups…",
      empty: "No groups yet. Add a machine type, then assign resources under Resources.",
      add: "New group",
      edit: "Edit group",
      delete: "Delete group",
      deleteConfirm: "Delete this machine group? Resources will be ungrouped.",
      save: "Save",
      saving: "Saving…",
      ...
      machineCount: "{count} resources in group",
      apiError: "API error.",
    },
    spareParts: {
    ...
    compatibility: {
      title: "Part-Machine Compatibility",
