...
export const en: AppDictionary = {
  ...
  admin: {
    ...
    machines: {
      dictTitle: "Equipment types",
      dictSubtitle: "Vehicle and machine categories.",
      addCategory: "Add category",
      noCategories: "Add a category first (e.g. transport, workshop) to assign vehicles.",
      fleetTitle: "Machines & workshop",
      fleetSubtitle: "Fleet list linked to the categories above.",
      ...
      catPlaceholder: "e.g. Transport, Workshop",
      saveDict: "Save",
