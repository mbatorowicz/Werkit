  ...
  admin: {
    ...
    categories: {
      ...
      materials: {
        ...
        panelSubtitle: "Tree of groups and categories for classifying inventory items.",
    ...
    machines: {
      ...
      pageSubtitle: "Order & resource category tree and the registry for fleet and locations.",
    ...
    materials: {
      ...
      pageSubtitle: "Material category tree and inventory lines.",
