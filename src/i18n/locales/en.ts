...
export const en: AppDictionary = {
  apiErrors: {
    ...
    slug_exists: "This company slug is already taken.",
  ...
  platform: {
    ...
    companiesTitle: "Companies on the platform",
    colCompany: "Company",
    colSlug: "Slug",
    colUsers: "Accounts",
    colWorkers: "Workers",
    ...
    adminSection: "Company admin (optional on create)",
    adminName: "Full name",
    ...
    addAdminSuccess: "Administrator created.",
    noAdminYet: "No admin account yet — complete below.",
    toggleActive: "Toggle active",
    empty: "No companies besides the default tenant.",
  },
};
