...
export const en: AppDictionary = {
  ...
  common: {
    ...
    search: {
      ...
      noResultsForQuery: "No results for this query.",
    },
    errors: {
      ...
      routeFetch: "Could not fetch route.",
      pageLoad: "Loading error",
      pageLoadHint: "Try refreshing the page or logging in again.",
    ...
    warehouse: {
      ...
      colDate: "Date",
      colNotes: "Notes",
      movementsFilterSummary: "Issue totals for filter:",
      movementsFilterSummaryLine: "{item}: {qty} {unit}",
      emptyReceipts: "No receipts yet.",
      emptyIssues: "No issues yet.",
      modalReceiptTitle: "Stock receipt (PZ)",
      modalIssueTitle: "Stock issue (WZ)",
      movementSaveSuccess: "Stock movement saved.",
      adjustment: {
        title: "Stock adjustment",
        modalTitle: "Adjust warehouse stock",
        save: "Save stock",
  ...
  apiErrors: {
    ...
    company_inactive: "The organization is inactive.",
    user_inactive: "This account is inactive.",
    already_impersonating: "A support session is already active. End it first.",
    no_resume: "No platform session to restore.",
  },
  workOrdersSchedule: {
  ...
  admin: {
    shared: {
      measureUnitLabel: "Unit of measure",
      minStockHint: "Alert when stock falls below this value (in the selected unit).",
      measureUnitOptions: {
        "szt.": "Piece (szt.)",
        "op.": "Package (op.)",
        kg: "Kilogram (kg)",
    ...
    organization: {
      ...
      unassignedEmpty: "All active workers are assigned to teams.",
      deptBadge: "Department",
      teamBadge: "Team",
    ...
    orders: {
      ...
      materialPickerChooseCategory: "Select material category…",
      materialPickerSearchMaterial: "Search material in category…",
      materialPickerNoCategories: "No material categories. Add them in the materials dictionary.",
      materialPickerNoMaterialsInCategory: "No materials in this category.",
      materialPickerClearCategory: "Remove material category",
    ...
    workers: {
      ...
      org: {
        ...
        deptManager: "Manager: {name}",
        teamLeader: "Leader: {name}",
        teamMember: "Team: {name}",
        supervisorTitle: "Supervisor",
        supervisorTeamLeader: "Team leader",
        supervisorDeptManager: "Department manager",
        supervisorDirect: "Assigned in profile",
        noOrg: "Not assigned to a department or team.",
      },
      supervisorLabel: "Supervisor (optional)",
      supervisorNone: "— None —",
      supervisorPlaceholder: "Select supervisor…",
      supervisorClear: "Clear supervisor",
      teamDepartmentLabel: "Department",
      teamDepartmentPlaceholder: "Select department…",
      teamDepartmentClear: "Clear department",
      teamDepartmentNone: "— None —",
      teamLabel: "Team",
      teamPlaceholder: "Select team…",
      teamClear: "Clear team",
      teamNone: "— None —",
    ...
    materials: {
      ...
      locationPlaceholder: "e.g. Silo A, yard 2",
      warehouse: {
        adjustHint: "Set current stock for “{name}” (in {unit}).",
        invalidQuantity: "Invalid quantity.",
        movementsSubtitle:
          "PZ (receipts) and WZ (issues). Auto WZ when a session starts with material.",
        colCustomer: "Customer",
        colMaterial: "Material",
        movementsSearchPlaceholder: "Search by customer, material, order, notes…",
        fieldMaterial: "Material",
        fieldMaterialPlaceholder: "Select material…",
        fieldQuantity: "Quantity",
        fieldQuantityWithUnit: "Quantity ({unit})",
        fieldUnitPrice: "Unit price (net)",
    ...
    customers: {
      ...
      streetPlaceholder: "e.g. 21 Forest St",
      cityLabel: "City",
      cityPlaceholder: "e.g. Warsaw",
      postalCodeLabel: "Postal code",
      postalCodePlaceholder: "e.g. 00-000",
    ...
    logs: {
      ...
      exportJsonHint: "Download up to {max} newest device log entries.",
  ...
  worker: {
    ...
    client: {
      ...
      delegateOrderButton: "Delegate order",
      delegateOrderTitle: "Delegate order to worker",
      delegateOrderSubmit: "Send order",
      delegateOrderSuccess: "Order has been assigned.",
      delegateChooseWorker: "Worker",
      delegateChooseCategory: "Order category",
      delegateChooseMachine: "Resource",
      delegateTaskDescription: "Task description",
      ...
      gpsBackgroundDisclosure:
        "The Werkit app collects location data to enable tracking of employee routes during an active work session, even when the app is closed or not in use.",
      gpsPrivacyPolicy: "Privacy policy",
      ...
      materialPickerChooseCategory: "Select material category…",
      materialPickerSearchMaterial: "Search material in category…",
      materialPickerNoCategories: "No material categories.",
      materialPickerNoMaterialsInCategory: "No materials in this category.",
      materialPickerClearCategory: "Remove material category",
    ...
    profile: {
      ...
      title: "Your Profile",
      org: {
        sectionTitle: "Your position in the company",
        deptManager: "Manager: {name}",
        teamLeader: "Leader: {name}",
        teamMember: "Team: {name}",
        supervisorTitle: "Supervisor",
        ...
        supervisorDeptManager: "Department manager",
        supervisorDirect: "Assigned in profile",
        noOrg: "You are not assigned to a department or team.",
      },
  ...
  platform: {
    ...
    colLastAdminLogin: "Last admin login",
    colLastWorkerLogin: "Last worker login",
    colActiveSessions: "Sessions now",
    colErrorLogs24h: "Errors (24 h)",
    colStatus: "Status",
    colActions: "Actions",
    statusActive: "Active",
    ...
    lifecycleHint:
      "Suspended and archived block sign-in. Archiving does not delete sessions, GPS, or warehouse data.",
    internalNote: "Support note",
    internalNotePlaceholder: "Onboarding context, contract, ticket…",
    internalNoteHint: "Visible only on the platform console. Max 2000 characters.",
    archiveCompany: "Archive",
    archiveCompanyConfirm:
      "Archive {name}? Accounts will not be able to sign in. Data (sessions, GPS, warehouse) is kept — nothing is deleted.",
    hideArchived: "Hide archived",
    addAdminInactiveHint:
      "You cannot add an administrator while the organization is suspended or archived.",
    organizationName: "Organization name",
    organizationNamePlaceholder: "e.g. Acme Logistics Ltd.",
    organizationSlug: "Identifier",
    organizationSlugPlaceholder: "e.g. logistics-co",
    ...
    addAdminHeading: "Add administrator",
    ...
    deactivateUserConfirm:
      "Deactivate account {name} ({login})? They will not be able to sign in until the account is turned back on.",
    activateUserConfirm: "Activate account {name} ({login})?",
    resetPassword: "Reset password",
    resetPasswordNew: "New password",
    resetPasswordConfirm: "Set a new password for {name}? The password will not be shown again.",
    resetPasswordSuccess: "Password has been changed.",
    resetPasswordError: "Could not change the password.",
    userStatusError: "Could not change account status.",
    usersLoadError: "Could not load the account list.",
    impersonateAsViewer: "Enter as viewer",
    impersonateAsAdmin: "Enter as admin",
    impersonateReason: "Reason (optional)",
    impersonateReasonPlaceholder: "e.g. support ticket",
    impersonateConfirmViewer:
      "Open the organization admin panel as {name} (read-only — no writes)?",
    impersonateConfirmAdmin: "Open the organization admin panel as administrator {name}?",
    impersonateConfirmAdminDanger:
      "Mutations in the panel will be stored as {name}. This is full administrator access. Continue?",
    impersonateError: "Could not start the support session.",
    impersonationBanner: "Platform support — company {company}. You are acting as {user}.",
    impersonationEnd: "End",
    impersonationEndError: "Could not return to the platform console.",
    saveChanges: "Save",
    cancelEdit: "Cancel",
    ...
    tabMetrics: "Metrics",
    productLimitsTitle: "Product limits (fixed)",
    productLimitsHint:
      "Not billing counters. GPS {gps} points/request, photos {photoMb} MiB, logs {logs}/min/user.",
    accountsInOrg: "Accounts in organization: {count}",
    settings: {
      ...
      gpsModuleHint:
        "Each switch is independent: turning off geofence or navigation does not stop GPS tracking.",
      ...
      geofencingEnabledHint: "Confirm “Arrived” when the worker is outside the destination radius.",
      ...
      planPresetsTitle: "Package template",
      planPresetsHint:
        "A preset sets GPS and DUR flags in one click. A manual toggle switches the package to custom.",
      planFieldOps: "Field-ops",
      planFieldOpsHint: "GPS and map on, DUR off.",
      planFieldOpsMro: "Field-ops + MRO",
      planFieldOpsMroHint: "GPS, map, and DUR.",
      planYard: "Yard / workshop",
      planYardHint: "DUR on, GPS off.",
      planCustom: "Custom",
    },
    navRegistry: "Company registry",
    navAudit: "Audit log",
    auditTitle: "Platform audit log",
    auditSubtitle: "Trace of console actions. No editing or deletion. Passwords are never stored.",
    ...
    auditFilterCompany: "Company",
    auditFilterAction: "Action",
    auditFilterAll: "All",
    auditCompanyGlobal: "no company",
    helpLink: "Help",
    help: getHelpBundle("en").platform,
  },
  dur: {
    sidebar: {
