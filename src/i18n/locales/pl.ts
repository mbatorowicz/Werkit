...
export const pl = {
  ...
  apiErrors: {
    ...
    company_inactive: "Organizacja jest nieaktywna.",
    user_inactive: "To konto jest nieaktywne.",
    already_impersonating: "Sesja wsparcia jest już aktywna. Najpierw ją zakończ.",
    no_resume: "Brak sesji platformy do przywrócenia.",
  },
  workOrdersSchedule: {
  ...
  platform: {
    ...
    colLastAdminLogin: "Ostatnie log. admina",
    colLastWorkerLogin: "Ostatnie log. pracownika",
    colActiveSessions: "Sesje teraz",
    colErrorLogs24h: "Błędy (24 h)",
    colStatus: "Status",
    colActions: "Akcje",
    ...
    lifecycleLabel: "Status cyklu życia",
    lifecycleHint:
      "Zawieszenie i archiwum blokują logowanie. Archiwum nie kasuje sesji, GPS ani magazynu.",
    internalNote: "Notatka wsparcia",
    internalNotePlaceholder: "Kontekst onboardingu, umowy, zgłoszenia…",
    internalNoteHint: "Widoczna tylko w konsoli platformy. Maks. 2000 znaków.",
    archiveCompany: "Archiwizuj",
    ...
    addAdminHeading: "Dodaj administratora",
    ...
    lastLoginNever: "nigdy",
    quietChip: "cicha",
    roleAdmin: "Administrator",
    roleViewer: "Podgląd",
    userActive: "Aktywne",
    userInactive: "Nieaktywne",
    deactivateUser: "Dezaktywuj",
    activateUser: "Aktywuj",
    deactivateUserConfirm:
      "Dezaktywować konto {name} ({login})? Osoba nie zaloguje się, dopóki konto nie zostanie włączone.",
    activateUserConfirm: "Aktywować konto {name} ({login})?",
    resetPassword: "Reset hasła",
    resetPasswordNew: "Nowe hasło",
    resetPasswordConfirm: "Ustawić nowe hasło dla {name}? Hasło nie będzie pokazane ponownie.",
    resetPasswordSuccess: "Hasło zostało zmienione.",
    resetPasswordError: "Nie udało się zmienić hasła.",
    userStatusError: "Nie udało się zmienić statusu konta.",
    usersLoadError: "Nie udało się wczytać listy kont.",
    impersonateAsViewer: "Wejdź jako podgląd",
    impersonateAsAdmin: "Wejdź jako admin",
    impersonateReason: "Powód (opcjonalnie)",
    impersonateReasonPlaceholder: "np. zgłoszenie wsparcia",
    impersonateConfirmViewer:
      "Wejść do panelu organizacji jako {name} (podgląd — bez zapisu zmian)?",
    impersonateConfirmAdmin: "Wejść do panelu organizacji jako administrator {name}?",
    impersonateConfirmAdminDanger:
      "Mutacje w panelu będą zapisane na koncie {name}. To pełny dostęp administratora. Kontynuować?",
    impersonateError: "Nie udało się rozpocząć sesji wsparcia.",
    impersonationBanner: "Wsparcie platformy — firma {company}. Działasz jako {user}.",
    impersonationEnd: "Zakończ",
    impersonationEndError: "Nie udało się wrócić do konsoli platformy.",
    saveChanges: "Zapisz",
    cancelEdit: "Anuluj",
    ...
    productLimitsTitle: "Limity produktu (stałe)",
    productLimitsHint:
      "Nie są licznikami billingowymi. GPS {gps} pkt/żądanie, foto {photoMb} MiB, logi {logs}/min/osobę.",
    ...
    settings: {
      ...
      gpsModuleHint:
        "Każda funkcja działa osobno: wyłączenie geofence albo nawigacji nie wyłącza śledzenia pozycji.",
      ...
      geofencingEnabledHint: "Potwierdzenie „Dojechał”, gdy pracownik jest poza promieniem celu.",
      ...
      planPresetsTitle: "Szablon pakietu",
      planPresetsHint:
        "Preset ustawia flagi GPS i DUR za jednym kliknięciem. Ręczne przełączenie zmienia pakiet na „własny”.",
      planFieldOps: "Field-ops",
      planFieldOpsHint: "GPS i mapa włączone, DUR wyłączony.",
      planFieldOpsMro: "Field-ops + MRO",
      planFieldOpsMroHint: "GPS, mapa i DUR.",
      planYard: "Plac / warsztat",
      planYardHint: "DUR włączony, GPS wyłączony.",
      planCustom: "Własny",
    },
    navRegistry: "Rejestr firm",
    navAudit: "Dziennik",
    auditTitle: "Dziennik platformy",
    auditSubtitle: "Ślad działań konsoli. Bez edycji i usuwania. Nie zawiera haseł.",
    auditEmpty: "Brak zdarzeń.",
    auditLoading: "Wczytywanie dziennika…",
    auditLoadError: "Nie udało się wczytać dziennika.",
    auditColTime: "Czas",
    auditColActor: "Aktor",
