  ...
  admin: {
    ...
    materials: {
      ...
      warehouse: {
        ...
        lowStock: "Niski stan",
        adjustStock: "Korekta",
        adjustTitle: "Korekta stanu magazynowego",
        adjustHint: "Ustaw bieżący stan dla materiału „{name}” (w {unit}).",
        adjustSave: "Zapisz stan",
        adjustCancel: "Anuluj",
        invalidQuantity: "Nieprawidłowa ilość.",
        movementsTitle: "Przyjęcia i wydania",
        movementsSubtitle: "Rejestr PZ (przyjęć) i WZ (wydań) materiałów. WZ automatyczne przy starcie sesji z materiałem.",
        ...
        movementsSearchNoResults: "Brak wyników dla tego zapytania.",
        ...
        save: "Zapisz",
        cancel: "Anuluj",
        saveSuccess: "Zapisano ruch magazynowy.",
      },
    },
    customers: {
      title: "Klienci",
