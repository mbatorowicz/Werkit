export const pl = {
  ...
  admin: {
    ...
    machines: {
      dictTitle: "Typy sprzętu",
      dictSubtitle: "Kategorie pojazdów i maszyn.",
      addCategory: "Dodaj kategorię",
      noCategories: "Dodaj pierwszą kategorię (np. transport, warsztat), żeby przypisywać pojazdy.",
      fleetTitle: "Maszyny i warsztat",
      fleetSubtitle: "Lista pojazdów wg kategorii powyżej.",
      ...
      catPlaceholder: "Np. Transport, Warsztat",
      saveDict: "Zapisz",
