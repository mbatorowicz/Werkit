export const pl = {
  ...
  dur: {
    sidebar: {
      resourceGroups: "Grupy maszyn",
      spareParts: "Katalog części",
      sparePartCategories: "Kategorie części",
      warehouse: "Gospodarka magazynowa",
    },
    resourceGroups: {
      title: "Grupy maszyn (typy zasobów)",
      subtitle:
        "Typ urządzenia dla modułu DUR — np. kapsułkarka 02A. Wiele egzemplarzy tego samego modelu przypisujesz do jednej grupy w rejestrze zasobów.",
      assignHint:
        "Przypisanie konkretnej maszyny do grupy: Zasoby → edycja zasobu → pole „Grupa maszyn”.",
      loading: "Ładowanie grup…",
      empty: "Brak grup. Dodaj typ maszyny, potem przypisz zasoby w module Zasoby.",
      add: "Nowa grupa",
      edit: "Edytuj grupę",
      delete: "Usuń grupę",
      deleteConfirm: "Usunąć tę grupę maszyn? Zasoby pozostaną bez grupy.",
      save: "Zapisz",
      saving: "Zapisywanie…",
      ...
      machineCount: "{count} zasobów w grupie",
      apiError: "Błąd API.",
    },
    spareParts: {
