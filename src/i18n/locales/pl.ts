export const pl = {
  apiErrors: {
    ...
    slug_exists: "Ten slug firmy jest już zajęty.",
  ...
  platform: {
    ...
    usageTitle: "Statystyki użytkowania",
    companiesTitle: "Firmy na platformie",
    colCompany: "Firma",
    colSlug: "Slug",
    colUsers: "Konta",
    ...
    statusInactive: "Wyłączona",
    createCompany: "Nowa firma",
    companyName: "Nazwa firmy",
    companySlug: "Slug (opcjonalnie)",
    adminSection: "Administrator firmy (opcjonalnie przy tworzeniu)",
    adminName: "Imię i nazwisko",
    adminEmail: "E-mail logowania",
    adminPassword: "Hasło",
    submitCreate: "Utwórz firmę",
    createSuccess: "Firma została utworzona.",
    createError: "Nie udało się utworzyć firmy.",
    addAdmin: "Dodaj administratora",
    addAdminSuccess: "Administrator został utworzony.",
    noAdminYet: "Brak konta admina — uzupełnij poniżej.",
    toggleActive: "Przełącz aktywność",
    empty: "Brak firm poza firmą domyślną.",
  },
};
