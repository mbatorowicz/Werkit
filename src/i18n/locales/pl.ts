  ...
  admin: {
    ...
    materials: {
      ...
      pageSubtitleWarehouse:
        "Katalog materiałów, stan magazynowy w tonach oraz przyjęcia i wydania.",
      minStockLabel: "Minimalny stan (t)",
      ...
      warehouse: {
        ...
        adjustHint: "Ustaw bieżący stan dla materiału „{name}” (w tonach).",
