  ...
  admin: {
    ...
    categories: {
      ...
      materials: {
        ...
        panelSubtitle: "Drzewo grup i kategorii do klasyfikacji pozycji w bazie materiałów.",
    ...
    machines: {
      ...
      pageSubtitle: "Drzewo kategorii zleceń i zasobów oraz rejestr wpisów floty i lokalizacji.",
    ...
    materials: {
      ...
      pageSubtitle: "Drzewo kategorii materiałów oraz pozycje magazynowe.",
