export const pl = {
  ...
  admin: {
    ...
    machines: {
      ...
      confirmMachDelete: "Czy na pewno usunąć tę maszynę z listy floty?",
      apiError: "Błąd API.",
      ...
      machCatWarning: "Najpierw dodaj kategorię sprzętu powyżej — bez niej nie można przypisać pojazdu.",
