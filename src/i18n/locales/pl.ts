export const pl = {
  ...
  admin: {
    ...
    workers: {
      ...
      createWarning: "Zgodnie z protokołem bezpieczeństwa przekaż wygenerowany login i PIN użytkownikowi. Hasło zostanie zaszyfrowane (bcrypt).",
    ...
    machines: {
      ...
      catColorLabel: "Kolor Kategorii",
      catColorHint: "Wybierz główny kolor znaczników",
      catParamsTitle: "Parametry Zlecenia dla tej Klasy",
      reqCustomer: "Wymaga podania klienta",
      reqMaterial: "Wymaga podania materiału/kruszywa",
      reqQuantity: "Wymaga podania ilości w tonach",
      reqTaskDescription: "Wymaga opisu zadania",
      isGlobalLabel: "Dotyczy wszystkich maszyn (Globalny)",
      isGlobalDesc: "Np. dla Warsztatu - pokaże wszystkie maszyny na liście.",
      machCatSelectMany: "Wybierz jedną lub więcej kategorii",
      machPhotoLabel: "Zdjęcie Pojazdu / Maszyny",
      machPhotoHint: "Obraz zostanie zmniejszony i zapisany jako WebP lub JPG.",
      machPhotoChoose: "Wybierz zdjęcie",
      machPhotoRemove: "Usuń zdjęcie",
    },
    materials: {
      title: "Baza Kruszyw",
      subtitle: "Najpierw kategorie kruszyw, potem lista materiałów — jak w sekcji Maszyny i warsztat.",
      dictTitle: "Słownik Kategorii Kruszyw",
      dictSubtitle: "Grupy materiałów przypisywane do pozycji w bazie asortymentowej.",
      addCategory: "Dodaj kategorię",
      noCategories: "Dodaj pierwszą kategorię kruszyw, aby móc klasyfikować materiały.",
      fleetTitle: "Materiały i Asortyment",
      fleetSubtitle: "Rejestruj materiały wg typu i kategorii utworzonych powyżej.",
      ...
      modalCatCreateTitle: "Nowa Kategoria Kruszyw",
      ...
      matCatLabel: "Kategorie kruszyw (z słownika)",
      typeSand: "Piasek",
      typeGravel: "Żwir",
      typeMix: "Pospółka",
  ...
  worker: {
    client: {
      ...
      checkpointNote: "📍 Meldunek: dotarcie na miejsce zdarzenia.",
      orderedBy: "Zlecił(a):",
      ...
      wizardMaterialLabel: "Jakie kruszywo ładujesz?",
      ...
      wizardQuantityLabel: "Ilość kruszywa (tony)",
      ...
      wizardSummaryAggregate: "Kruszywo:",
