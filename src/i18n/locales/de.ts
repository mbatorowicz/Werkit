  ...
  admin: {
    ...
    materials: {
      ...
      pageSubtitleWarehouse:
        "Materialkatalog, Lagerbestand in Tonnen sowie Ein- und Ausgänge.",
      minStockLabel: "Mindestbestand (t)",
      minStockPlaceholder: "z.B. 50",
      locationLabel: "Lagerort",
      locationPlaceholder: "z.B. Silo A, Platz 2",
      warehouse: {
        stockColumn: "Bestand (t)",
        unit: "t",
        lowStock: "Niedriger Bestand",
        adjustStock: "Korrektur",
        adjustTitle: "Lagerbestand korrigieren",
        adjustHint: "Aktuellen Bestand für „{name}“ setzen (in Tonnen).",
