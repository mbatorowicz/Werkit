...
export const de: AppDictionary = {
  ...
  common: {
    ...
    warehouse: {
      ...
      stockSublabel: "Bestand: {qty} {unit}",
      ...
      addReceipt: "Neuer Eingang",
      addIssue: "Neuer Ausgang",
      colQuantity: "Menge",
      colDate: "Datum",
      colNotes: "Anmerkungen",
      movementsFilterSummary: "Summe der Ausgänge für den Filter:",
      movementsFilterSummaryLine: "{item}: {qty} {unit}",
      emptyReceipts: "Keine Eingänge.",
      emptyIssues: "Keine Ausgänge.",
      modalReceiptTitle: "Wareneingang (PZ)",
      modalIssueTitle: "Warenausgang (WZ)",
      movementSaveSuccess: "Lagerbewegung gespeichert.",
      adjustment: {
        title: "Bestandskorrektur",
        modalTitle: "Lagerbestand korrigieren",
        ...
        notesPlaceholder: "z.B. Inventur, Fehler beim Eingang",
      },
    },
    categories: {
      shared: {
  ...
  admin: {
    shared: {
      measureUnitLabel: "Maßeinheit",
      minStockHint: "Warnung, wenn der Bestand unter diesen Wert fällt (in der gewählten Einheit).",
      measureUnitOptions: {
        "szt.": "Stück (szt.)",
        "op.": "Packung (op.)",
        kg: "Kilogramm (kg)",
    ...
    organization: {
      ...
      unassignedEmpty: "Alle aktiven Mitarbeiter sind Teams zugeordnet.",
      deptBadge: "Abteilung",
      teamBadge: "Team",
    ...
    orders: {
      ...
      materialPickerChooseCategory: "Materialkategorie wählen…",
      materialPickerSearchMaterial: "Material in Kategorie suchen…",
      materialPickerNoCategories: "Keine Materialkategorien. Im Materialverzeichnis anlegen.",
      materialPickerNoMaterialsInCategory: "Keine Materialien in dieser Kategorie.",
      materialPickerClearCategory: "Materialkategorie entfernen",
    ...
    workers: {
      ...
      org: {
        sectionTitle: "Organisationsstruktur",
        deptManager: "Leiter: {name}",
        teamLeader: "Teamleiter: {name}",
        teamMember: "Team: {name}",
        supervisorTitle: "Vorgesetzter",
        supervisorTeamLeader: "Teamleiter",
        supervisorDeptManager: "Abteilungsleiter",
        supervisorDirect: "Im Profil angegeben",
        noOrg: "Keiner Abteilung oder keinem Team zugeordnet.",
      },
      supervisorLabel: "Vorgesetzter (optional)",
      supervisorNone: "— Keiner —",
      supervisorPlaceholder: "Vorgesetzten wählen…",
      supervisorClear: "Vorgesetzten entfernen",
      teamDepartmentLabel: "Abteilung",
      teamDepartmentPlaceholder: "Abteilung wählen…",
      teamDepartmentClear: "Abteilung entfernen",
      teamDepartmentNone: "— Keine —",
      teamLabel: "Team",
      teamPlaceholder: "Team wählen…",
      teamClear: "Team entfernen",
      teamNone: "— Keine —",
    ...
    materials: {
      ...
      locationPlaceholder: "z.B. Silo A, Platz 2",
      warehouse: {
        adjustHint: "Aktuellen Bestand für „{name}“ setzen (in {unit}).",
        invalidQuantity: "Ungültige Menge.",
        movementsSubtitle:
          "PZ (Eingänge) und WZ (Ausgänge). Automatisches WZ beim Sitzungsstart mit Material.",
        colCustomer: "Kunde",
        colMaterial: "Material",
        movementsSearchPlaceholder: "Suche nach Kunde, Material, Auftrag, Anmerkungen…",
        fieldMaterial: "Material",
        fieldMaterialPlaceholder: "Material wählen…",
        fieldQuantity: "Menge",
        fieldQuantityWithUnit: "Menge ({unit})",
        fieldUnitPrice: "Stückpreis (netto)",
        fieldInvoice: "Rechnungsnr.",
    ...
    customers: {
      ...
      streetPlaceholder: "z. B. Musterstraße 21",
      cityLabel: "Ort",
  ...
  worker: {
    ...
    client: {
      ...
      delegateOrderButton: "Auftrag delegieren",
      delegateOrderTitle: "Auftrag an Mitarbeiter delegieren",
      delegateOrderSubmit: "Auftrag senden",
      delegateOrderSuccess: "Auftrag wurde zugewiesen.",
      delegateChooseWorker: "Mitarbeiter",
      delegateChooseCategory: "Auftragskategorie",
      delegateChooseMachine: "Ressource",
      delegateTaskDescription: "Aufgabenbeschreibung",
      delegateDueDate: "Fälligkeit",
      ...
      materialPickerChooseCategory: "Materialkategorie wählen…",
      materialPickerSearchMaterial: "Material in Kategorie suchen…",
      materialPickerNoCategories: "Keine Materialkategorien.",
      materialPickerNoMaterialsInCategory: "Keine Materialien in dieser Kategorie.",
      materialPickerClearCategory: "Materialkategorie entfernen",
    ...
    profile: {
      ...
      title: "Ihr Profil",
      org: {
        sectionTitle: "Ihre Position im Unternehmen",
        deptManager: "Leiter: {name}",
        teamLeader: "Teamleiter: {name}",
        teamMember: "Team: {name}",
        supervisorTitle: "Vorgesetzter",
        ...
        supervisorDeptManager: "Abteilungsleiter",
        supervisorDirect: "Im Profil angegeben",
        noOrg: "Sie sind keiner Abteilung oder keinem Team zugeordnet.",
      },
  ...
  platform: {
    ...
    colLastAdminLogin: "Letzte Admin-Anmeldung",
    colLastWorkerLogin: "Letzte Arbeiter-Anmeldung",
    colActiveSessions: "Sitzungen jetzt",
    colErrorLogs24h: "Fehler (24 Std.)",
    colStatus: "Status",
    colActions: "Aktionen",
    statusActive: "Aktiv",
    ...
    lifecycleLabel: "Lebenszyklusstatus",
    lifecycleHint:
      "Gesperrt und archiviert blockieren die Anmeldung. Archivieren löscht keine Sitzungen, GPS- oder Lagerdaten.",
    internalNote: "Supportnotiz",
    internalNotePlaceholder: "Onboarding-Kontext, Vertrag, Ticket…",
    internalNoteHint: "Nur in der Plattformkonsole sichtbar. Max. 2000 Zeichen.",
    archiveCompany: "Archivieren",
    archiveCompanyConfirm:
      "{name} archivieren? Konten können sich nicht anmelden. Daten (Sitzungen, GPS, Lager) bleiben — nichts wird gelöscht.",
    hideArchived: "Archivierte ausblenden",
    addAdminInactiveHint:
      "Kein Administrator, solange die Organisation gesperrt oder archiviert ist.",
    ...
    addAdminHeading: "Administrator hinzufügen",
    ...
    deactivateUserConfirm:
      "Konto {name} ({login}) deaktivieren? Die Person kann sich nicht anmelden, bis das Konto wieder eingeschaltet wird.",
    activateUserConfirm: "Konto {name} ({login}) aktivieren?",
    resetPassword: "Passwort zurücksetzen",
    resetPasswordNew: "Neues Passwort",
    resetPasswordConfirm:
      "Neues Passwort für {name} setzen? Das Passwort wird nicht erneut angezeigt.",
    resetPasswordSuccess: "Passwort wurde geändert.",
    ...
    tabAdmins: "Administratoren",
    tabMetrics: "Kennzahlen",
    productLimitsTitle: "Produktlimits (fest)",
    productLimitsHint:
      "Keine Billing-Zähler. GPS {gps} Punkte/Anfrage, Fotos {photoMb} MiB, Protokolle {logs}/Min./Nutzer.",
    accountsInOrg: "Konten in der Organisation: {count}",
    settings: {
      ...
      gpsModuleHint:
        "Jeder Schalter ist unabhängig: Geofence oder Navigation aus schaltet die Positionsverfolgung nicht ab.",
      ...
      planPresetsTitle: "Paketvorlage",
      planPresetsHint:
        "Eine Vorlage setzt GPS- und DUR-Schalter mit einem Klick. Ein manueller Schalter wechselt auf „Benutzerdefiniert“.",
      planFieldOps: "Field-ops",
      planFieldOpsHint: "GPS und Karte an, DUR aus.",
      planFieldOpsMro: "Field-ops + MRO",
      planFieldOpsMroHint: "GPS, Karte und DUR.",
      planYard: "Hof / Werkstatt",
      planYardHint: "DUR an, GPS aus.",
      planCustom: "Benutzerdefiniert",
    },
    navRegistry: "Firmenregister",
    navAudit: "Protokoll",
    auditTitle: "Plattformprotokoll",
    auditSubtitle:
      "Spur der Konsolenaktionen. Kein Bearbeiten und kein Löschen. Passwörter werden nicht gespeichert.",
    auditEmpty: "Keine Ereignisse.",
    auditLoading: "Protokoll wird geladen…",
    auditLoadError: "Protokoll konnte nicht geladen werden.",
    auditColTime: "Zeit",
    auditColActor: "Akteur",
    auditColCompany: "Firma",
    auditColAction: "Aktion",
    auditColTarget: "Ziel",
    auditFilterCompany: "Firma",
    auditFilterAction: "Aktion",
    auditFilterAll: "Alle",
    auditCompanyGlobal: "ohne Firma",
    helpLink: "Hilfe",
