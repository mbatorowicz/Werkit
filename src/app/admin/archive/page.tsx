...
export default function ArchivePage() {
  return (
    <div className="p-8 max-w-7xl mx-auto h-full flex flex-col">
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl flex-1 flex flex-col overflow-hidden shadow-sm">
        {/* Pasek filtrowania */}
        <div className="p-4 border-b border-zinc-800 flex items-center gap-4 bg-[#0a0a0b]">
          <div className="relative flex-1 max-w-sm">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-zinc-500" />
            <input 
              type="text" 
              placeholder="Szukaj po operatorze lub maszynie..." 
              className="w-full bg-zinc-950 border border-zinc-800 rounded-lg pl-9 pr-4 py-2 text-sm text-zinc-200 focus:ring-1 focus:ring-zinc-600 focus:border-zinc-600 transition outline-none"
            />
          </div>
        ...
        <div className="flex-1 p-8 flex flex-col justify-center items-center text-center bg-zinc-950/50">
           <div className="w-16 h-16 bg-[#0a0a0b] border border-zinc-800 rounded-full flex items-center justify-center mb-4 shadow-inner">
