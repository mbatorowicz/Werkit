...
export default async function DashboardPage() {
  ...
  // Gantt Chart Data
  // Removed from here since it's moved to the dashboard.

  return (
    <div className="p-6 md:p-8 max-w-[1600px] mx-auto w-full">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          <h1 className="text-2xl font-semibold text-zinc-900 dark:text-white tracking-tight flex items-center gap-2"><BarChart3 className="w-6 h-6 text-emerald-500" /> Raporty i Statystyki</h1>
          <p className="text-zinc-500 mt-1">Bieżące podsumowanie operacji i statystyki {companySSOT?.companyName || "Twojej firmy"}.</p>
        </div>
      </div>
