...
export default async function HistoryPage() {
  ...
  return (
    <div className="py-6 pb-20">
      <h1 className="text-2xl font-bold text-white mb-6">Historia Pracy</h1>
              ...
              <div key={s.id} className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4">
                 ...
                 {s.sessionType === 'TRANSPORT' ? (
                   <div className="flex flex-wrap gap-2 text-xs">
                      <span className="bg-zinc-950 border border-zinc-800 px-2 py-1 rounded text-zinc-300">
                   ...
                   <div className="text-sm text-zinc-500 bg-zinc-950 p-3 rounded-xl border border-zinc-800">
