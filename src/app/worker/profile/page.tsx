...
export default async function ProfilePage() {
  ...
  return (
    <div className="py-6 pb-20">
      <h1 className="text-2xl font-bold text-white mb-8">Twój Profil</h1>
      
      <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6 flex flex-col items-center mb-6 shadow-inner">
         <div className="w-24 h-24 bg-zinc-950 border-2 border-zinc-800 rounded-full flex items-center justify-center mb-4">
      ...
      <div className="space-y-4">
         <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 flex justify-between items-center">
            ...
            <span className="text-white font-mono bg-zinc-950 px-3 py-1 rounded-md border border-zinc-800">
              {user?.usernameEmail}
            </span>
         </div>

         <Link href="/api/auth/logout" prefetch={false} className="w-full flex items-center justify-center gap-3 bg-zinc-900 hover:bg-red-500/10 hover:text-red-400 text-zinc-400 border border-zinc-800 rounded-2xl p-5 transition-colors group mt-8">
