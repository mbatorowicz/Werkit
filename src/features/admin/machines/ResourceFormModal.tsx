      ...
      <form onSubmit={onSubmit} className="space-y-6 p-6">
        ...
        <div className="border-t border-zinc-800 pt-4">
          <button
            ...
            type="submit"
            className="w-full rounded-lg bg-emerald-600 py-3 text-sm font-bold text-white shadow-sm transition hover:bg-emerald-500 active:scale-[0.98] disabled:opacity-50"
          >
            {dict.saveFleet}
          </button>
        </div>
